...
> [!IMPORTANT]
> TypeScript is now the default language for all JavaScript and Node.js projects. Refer to existing [JavaScript style guides](javascript_node.md) for specific information on Javascript styling that isn't
